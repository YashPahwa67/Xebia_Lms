...
export default function StudentSubjects() {
  ...
  return (
    <div>
      <PageHeader title="My Courses" subtitle="Courses you're enrolled in this term" />
      {!subjects.length ? (
        <EmptyState title="No courses yet" message="You haven't been enrolled in any courses." />
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="mt-4 flex items-center justify-between border-t border-line/60 pt-3 text-sm">
                  <span className="flex items-center gap-1.5 text-slate/70"><FileText size={14} /> {notesForSubject(s.id).length} notes</span>
